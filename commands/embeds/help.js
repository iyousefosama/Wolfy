...
module.exports = {
  ...
  .addComponents(button, button2, button3, button4, button5);
    ...
    const msg = await message.lineReply({ content: `> <:Discordjs:805086222749007874> Wolfy is currently updating to \`djs-v13 wait\` for the huge update soon!`, embed : help, components : row})
