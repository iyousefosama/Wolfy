...
module.exports = {
    ...
    if(col.first().content !== 'TheLegendaryBaskokaMan!') return message.channel.send({ content: "<a:pp681:774089750373597185> **Wrong!**"});
    else if(col.first().content == `TheLegendaryBaskokaMan!`) return message.channel.send({ content: "<a:CHECKCHECK:841321920456556554> You typed the right password you are **awesome**!"}).then(msg => {
        setTimeout(() => { 
            setTimeout(function() {
