  ...
  async execute(client, message, args) {
    ...
    if (
      ...
      return message.channel.send(
        `\\❌ **${message.author.tag}**, You don't have a *bank* yet! To create one, type \`${client.prefix}register\`.`
      );
    }
      ...
      return data
        ...
        .then(() => {
          message.channel.send(
            `\\❌ **${message.author.tag}**, Your bank is overflowed please withdraw some money from your bank.`
          );
        })
        .catch((err) =>
          message.channel.send(
