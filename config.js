...
const settings = {
    ...
    client: {
      ...
      // Intents flags
      intents: [GatewayIntentBits.Guilds, GatewayIntentBits.GuildMembers/*, GatewayIntentBits.GuildPresences*/, GatewayIntentBits.GuildMessages, GatewayIntentBits.DirectMessages, GatewayIntentBits.GuildMessageReactions, GatewayIntentBits.GuildVoiceStates, GatewayIntentBits.MessageContent],
    ...
    channels: { debug: '840892477614587914', votes: "840892477614587914", chatbot: "1115038503139545108", changelogs: "887589978127863808" },
