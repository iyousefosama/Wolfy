...
module.exports = {
	...
	data: new SlashCommandBuilder()
		.setName('rpc')
		.setDescription('Play rpc game with the bot!')
        .addBooleanOption(option => option.setName('rock').setDescription('Select a boolean'))
        .addBooleanOption(option => option.setName('paper').setDescription('Select a boolean'))
        .addBooleanOption(option => option.setName('scissors').setDescription('Select a boolean')),
