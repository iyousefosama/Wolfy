  ...
  async execute(client, interaction) {
    ...
    const info = createCommandListEmbed("ℹ️ Information Commands", [
      {
        ...
        value: "Shows information about a server",
      },
      {
      ...
      },
      {
        ...
        value: "To get Minecraft user information",
      },
      {
      ...
      },
      {
        ...
        value: "Get a user's server avatar",
      }
    ]);
    ...
    const Utl = createCommandListEmbed("🛠️ Utility Commands", [
      ...
      },
      {
        ...
        value: "The bot will remind you for anything",
      },
      {
        name: `${client.config.prefix}report`,
        value: "Report a user to server moderators",
      },
      {
    ...
    const moderator = createCommandListEmbed("🛡️ Moderator Commands", [
      ...
      },
      {
        ...
        value: "Nuke any channel (this will delete all the channel and create new one)",
      },
      {
    ...
    const Fun = createCommandListEmbed("🎮 Fun Commands", [
      ...
      },
      {
        ...
        value: "Send your message as Clyde text message",
      },
      {
    ...
    const setup = createCommandListEmbed("⚙️ Setup Commands", [
      ...
      },
      {
        ...
        value: "Setup the report channel for user reports",
      },
      {
        name: `${client.config.prefix}setSuggch`,
        value: "Setup the suggestion channel for user suggestions",
      },
      {
      ...
      },
      {
        ...
        value: "Setup the leaver channel bot will send message when user leave there",
      },
      {
      ...
      },
      {
        ...
        value: "Set custom command prefix",
      }
    ]);
    ...
    const bot = createCommandListEmbed("🤖 Bot Commands", [
      {
        ...
        value: "Show bot stats and information",
      },
      {
      ...
      },
      {
        ...
        value: "Display main bot help list embed",
      },
      {
    ...
    const Eco = createCommandListEmbed("💰 Economy Commands", [
      ...
      },
      {
        ...
        value: "To check your credits balance in bank",
      },
      {
