	...
	async execute(client, interaction) {
        ...
        fetch(url, options)
            ...
            .then(json => {
                ...
                .setDescription(`<:Tag:836168214525509653> Prays times for country \`${country}\` in city \`${city}\`!`)
                .addFields(
            ...
            .catch(() => interaction.editReply({ content: '<:error:888264104081522698> Please enter valid country and city in the options!' }));
	},
};
